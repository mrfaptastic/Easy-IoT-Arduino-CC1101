...
#define STREAM_PKT_MAX_PAYLOAD_SIZE  		CCPACKET_MAX_SIZE-STREAM_PKT_OVERHEAD // Remaining payload space available = 58

#define CCPACKET_REC_SIZE               CCPACKET_MAX_SIZE+2    // Payload + 2 bytes for lqi and rssi
